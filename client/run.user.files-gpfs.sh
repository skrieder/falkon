...
#MAX_EXECUTORS=2
#MAX_NUM_TASKS=( 1024	4096	4096	2048	1024	512	128	16 )
#MAX_EXECUTORS=4
#MAX_NUM_TASKS=( 2048	4096	4096	4096	2048	1024	256	32 )
#MAX_EXECUTORS=8
...
#MAX_NUM_TASKS=( 8192	8192	8192	4096	2048	1024	256	32 )
MAX_EXECUTORS=64
MAX_NUM_TASKS=( 8192	8192	8192	4096	2048	1024	256	64 )
EXP_DESC=( data_gpfs_read_write ) 
count=${#MAX_NUM_TASKS[*]}
expCount=${#EXP_DESC[*]}
for ((j=0; j < expCount ; j++))  # Double parentheses, and "LIMIT" with no "$".
...
#MAX_EXECUTORS=1
#MAX_NUM_TASKS=( 1024	1024	1024	1024	1024	512	128	16 )
#MAX_EXECUTORS=2
#MAX_NUM_TASKS=( 1024	4096	4096	4096	2048	1024	256	32 )
#MAX_EXECUTORS=4
#MAX_NUM_TASKS=( 2048	4096	4096	4096	4096	2048	512	64 )
#MAX_EXECUTORS=8
#MAX_NUM_TASKS=( 4096	4096	4096	4096	4096	2048	512	64 )
#MAX_EXECUTORS=16
#MAX_NUM_TASKS=( 8192	8192	8192	8192	4096	2048	512	64 )
#MAX_EXECUTORS=32
#MAX_NUM_TASKS=( 8192	8192	8192	8192	4096	2048	512	64 )
MAX_EXECUTORS=64
MAX_NUM_TASKS=( 8192	8192	8192	8192	4096	2048	512	64 )
EXP_DESC=( data_gpfs_read )
count=${#MAX_NUM_TASKS[*]}
expCount=${#EXP_DESC[*]}
for ((j=0; j < expCount ; j++))  # Double parentheses, and "LIMIT" with no "$".
do
...
#MAX_EXECUTORS=1
#MAX_NUM_TASKS=( 256	256	256	256	256	256	256	8 )
#MAX_EXECUTORS=2
#MAX_NUM_TASKS=( 256	256	256	256	256	256	256	16 )
#MAX_EXECUTORS=4
#MAX_NUM_TASKS=( 256	256	256	256	256	256	256	32 )
#MAX_EXECUTORS=8
#MAX_NUM_TASKS=( 256	256	256	256	256	256	256	32 )
#MAX_EXECUTORS=16
#MAX_NUM_TASKS=( 256	256	256	256	256	256	256	32 )
...
#MAX_NUM_TASKS=( 256	256	256	256	256	256	256	32 )
MAX_EXECUTORS=64
MAX_NUM_TASKS=( 256	256	256	256	256	256	256	64 )
EXP_DESC=( data_gpfs_wrapper_read_write )
count=${#MAX_NUM_TASKS[*]}
expCount=${#EXP_DESC[*]}
for ((j=0; j < expCount ; j++))  # Double parentheses, and "LIMIT" with no "$".
do
...
MAX_EXECUTORS=64
MAX_NUM_TASKS=( 256	256	256	256	256	256	256	64 )
EXP_DESC=( data_gpfs_wrapper_read )
count=${#MAX_NUM_TASKS[*]}
expCount=${#EXP_DESC[*]}
for ((j=0; j < expCount ; j++))  # Double parentheses, and "LIMIT" with no "$".
do
