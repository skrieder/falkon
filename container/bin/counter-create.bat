...
%_RUNJAVA%  %LOCAL_OPTS% %GLOBUS_OPTIONS% -classpath %LOCALCLASSPATH% org.globus.bootstrap.Bootstrap org.globus.wsrf.samples.counter.client.Create %CMD_LINE_ARGS%
