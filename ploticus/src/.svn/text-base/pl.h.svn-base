...
#define MAXDROWS 100000		/* default max # data rows - may be overridden using -maxrows */
#define MAXDAT 100000 		/* default max # of members in PLV vector - may be overridden */

#define MAXPROCLINES 100000	/* max # of proc lines in current proc plus all #saved 
					procs - may be overridden using -maxproclines */

#define MAXBIGBUF  100000 	/* size of PL_bigbuf (chars) */
#define MAXNCATS 10000		/* default max # of categories - may be overriden using proc categories listsize */
