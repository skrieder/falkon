...
export IDLE_TIME=$2
            ...
            #export LOG_FILE=${HOME_PATH}/logs/worker.${MACH_ID}.${RANDOM}.txt
...
#for ((b=0; b < 100 ; b++))
#do
            ${RAM_PATH}/${DIR_RAM}/BGexec ${FALKON_SERVICE_IP} 56000 56001 -perf >> "${LOG_FILE}" 2>&1
#${RAM_PATH}/${DIR_RAM}/BGexec_${PLATFORM} ${FALKON_SERVICE_IP} 56000 56001 -debug	
#/bin/sleep 1
#done           
