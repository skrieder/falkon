...
#            /bin/echo "starting... connecting to ${FALKON_SERVICE_IP}..." >> "${LOG_FILE}"
 ...
 #           ${HOME_PATH}/src-c/BGexec_${PLATFORM} ${FALKON_SERVICE_IP} 55000 55001 -perf >> "${LOG_FILE}" 2>&1 &
            #${HOME_PATH}/src-c/BGexec_${PLATFORM} ${FALKON_SERVICE_IP} 55000 55001 -debug
            #${HOME_PATH}/src-c/BGexec_${PLATFORM} ${FALKON_SERVICE_IP} 55000 55001 -perf
