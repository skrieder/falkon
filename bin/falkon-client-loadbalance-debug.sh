#!/bin/bash
 ...
 if [ -z "$6" ]; then 
              echo "usage: $0 <SERVICE_LIST_FILE> <NOTIFICATION_ENDPOINT> <EXEC_FILE> <NUM_TASKS> <BUNDLE_SIZE> <MAX_CONCURENT_TASKS>"
              exit 1
          fi
