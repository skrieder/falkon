#!/bin/bash
 ...
 if [ -z "$8" ]; then 
              echo "usage: $0 <GT4_IP> <GT4_PORT> <NUM_TASKS> <TASK_DURATION_MS> <SUBMIT_THROTTLE> <BUNDLE_SIZE> <NUM_THREADS> <MAX_CONCURENT_TASKS>"
              exit 1
          fi
