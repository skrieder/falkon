/**
 * GPServiceAddressingLocator.java
 *
...
public class GPServiceAddressingLocator extends org.globus.GenericPortal.stubs.GPService_instance.service.GPServiceLocator implements org.globus.GenericPortal.stubs.GPService_instance.service.GPServiceAddressing {
    public org.globus.GenericPortal.stubs.GPService_instance.GPPortType getGPPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	org.globus.GenericPortal.stubs.GPService_instance.GPPortType _stub = getGPPortTypePort(endpoint);
	if (_stub != null) {
