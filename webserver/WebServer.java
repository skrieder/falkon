...
class WebServer implements HttpConstants {
    ...
    static void loadProps() throws IOException {
        System.out.println("Trying to read from: " + System.getProperty("java.home")+File.separator+
    ...
    static void loadProps(String fileName) throws IOException {
        ...
        if (root == null) {
            ...
            if (!root.exists())
            {
                System.out.println(ROOT_PATH + " does not exist, reverting back to the default current directory " + System.getProperty("user.dir"));
                root = new File(System.getProperty("user.dir"));
            }
